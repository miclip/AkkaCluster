...
namespace AkkaCluster.Lighthouse.NetCoreApp
{
    public class LighthouseService
    {
        ...
        private IEnumerable<string> seedNodes;

        private ActorSystem _lighthouseSystem;

        public LighthouseService() : this(null, null, null) { }

        public LighthouseService(string ipAddress, int? port, IEnumerable<string> seedNodes)
        {
        ...
        public void Start()
        {
            _lighthouseSystem = LighthouseHostFactory.LaunchLighthouse(ipAddress, port, seedNodes);
        }
